 ...
 * @author PC
 */
public class Medico_inicio extends javax.swing.JFrame {

    /**
     * Creates new form Admision
     */
    public Medico_inicio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospital/views/images/user-64(verde).png"))); // NOI18N
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, -1, 90));
        ...
        fondo.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 130, 160));
        ...
        fondo.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 100, 140, -1));
        ...
        fondo.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 240, 120, 50));
        ...
        fondo.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 240, 90, 50));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        Medico_cita mc = new Medico_cita();
        mc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Medico_inicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Medico_inicio().setVisible(true);
            }
        });
    }
